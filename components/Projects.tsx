        ...
        <div className='py-20' id='projects'>
            ...
            <div className="flex flex-wrap items-center justify-center p-4 gap-16 mt-10">
                {projects.map(({ id, title, des, img, iconLists, link }) => (
                    <div key={id} className='lg:min-h-[25rem] h-[21rem] flex items-center justify-center sm:w-96 w-[80vw]'>
                        ...
                        <PinContainer title={link} href={link}>
                            ...
                            <p className=" lg:font-normal font-light text-sm line-clamp-2" style={{ color: "#BEC1DD", margin: "1vh 0", }}>
                                {des}
                            </p>
